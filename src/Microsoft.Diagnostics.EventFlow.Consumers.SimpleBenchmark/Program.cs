...
namespace Microsoft.Diagnostics.EventFlow.Consumers.SimpleBenchmark
{
    class Program
    {
        ...
        static TimeSpan CoolDownTime = TimeSpan.FromSeconds(0);
        ...
        static void Main(string[] args)
        {
            ...
            var pipeline = new DiagnosticsPipeline(healthReporter, new IObservable<EventData>[] { eventSourceInput }, sinks);
