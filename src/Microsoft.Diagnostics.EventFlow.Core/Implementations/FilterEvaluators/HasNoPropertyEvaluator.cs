...
{
    internal class HasNoPropertyEvaluator : FilterEvaluator
    {
        ...
        {
            get { return string.Format(CultureInfo.InvariantCulture, "(__EqualityEvaluator:hasnoproperty {0})", this.propertyName); }
        }
